...
import com.vdzon.irrigation.dashboard.internal.api.DashboardDataResponse
...
class DashboardApiStepDefinitions {
    ...
    private var dashboardData: DashboardDataResponse? = null
    ...
    fun i_call_the_dashboard_data_api() {
        ...
        val result = response.expectStatus().isOk
            .expectBody(DashboardDataResponse::class.java).returnResult()
